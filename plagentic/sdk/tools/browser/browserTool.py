    ...
    async def _init_browser(self) -> BrowserContext:
        ...
        if not BrowserTool._initialized:
            try:
                ...
                # Handle BaseModel compatibility issues
                error_msg = f"Browser initialization failed due to compatibility issue: {str(e)}"
                print(error_msg)
